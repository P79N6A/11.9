...
<head>
    ...
    <script type="text/javascript">
        function monthPicker(elementId){
            var nowDate = new Date();
            var yearStart = 2016;
            var currentYear = nowDate.getFullYear();
            $('#' + elementId).append('<select id="mp_year" ><option></option></select><select id="mp_month" ><option></option></select>');
            while(yearStart <= currentYear){
                $('#mp_year').append('<option>' + yearStart + '</option>');
                yearStart++;
            }
            var i = 1;
            while(i < 13){
                ...
                $('#mp_month').append('<option>' + month + '</option>');
                i++ ;
            }
        }
        $(document).ready(function() {
            ...
            DatePickerExt.date("orderDate",options);
        });
    </script>
</head>
<body>
<div class="Container">
    <div class="Content fontText">
        <div class="information">
            <form action="${ctx}statistics/monthlyData" id="queryOrderForm" name="queryOrderForm" method="get">
                <div class="search">
                    <div class="search_tit"><h2>月交易数据统计</h2></div>
                    <div class="search_con" style="padding-left: 2%;padding-right: 0%">
                        <ul class="fix query_block">
                            ...
                            <li><label class="text_tit">日期：</label>
                                <input type="text" name="orderDate" id="orderDate" class="input_text"
...
<div class="clearer"></div>
<div class="result">
    <q:table queryService="frontEndQueryService" queryKey="queryMonthlyData" formId="queryOrderForm" class="list" >
        ...
        <q:column title="交易系统" escapeHtml="false" width="" >
