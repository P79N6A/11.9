...
public class AESUtil {
	...
	public static String aesEncrypt(String data) {
		if (StringUtils.isBlank(data)) {
			...
			return AES.encryptToBase64(data, CommonUtil.getNccashierEncryptKey());
		}
	}
	...
	public static String aesDecrypt(String data) {
		if (StringUtils.isBlank(data)) {
			...
			return AES.decryptFromBase64(data, CommonUtil.getNccashierEncryptKey());
		}
	}
	 ...
	 */
	public static String routeDecrypt(String merchantNo, String encRequestID)
			throws UnsupportedEncodingException {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String routeEncrypt(String merchantNo, String requestId)
			throws UnsupportedEncodingException {
		String aesKey = getKey(merchantNo);
