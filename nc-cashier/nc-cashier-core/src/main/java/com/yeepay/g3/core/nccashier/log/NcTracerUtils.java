 ...
 * @version:
 */
public class NcTracerUtils {

    private static final Logger LOGGER = LoggerFactory.getLogger(NcTracerUtils.class);

    private static final String SPAN_NAME = "nccashier";
    ...
    public static void main(String args[]) {
        NcTracerUtils.spanFormat("customerNum:{0}~requestId:{1}~biz:{2}~bizOrder:{3}","10040026668","test201710260029", "11" , "20171204232");
