...
/**
 * 类名称: APICflEasyConfirmPayRequestDTO <br>
 * 类描述: <br>
 *
 * @author: zhijun.wang
 * @since: 18/9/4 下午2:13
...
public class APICflEasyConfirmPayRequestDTO extends APIBasicRequestDTO {

    private static final long serialVersionUID = 193728340947881696L;
    ...
    public APICflEasyConfirmPayRequestDTO() {
    }
    ...
    public String toString() {
        return "APICflEasyConfirmPayRequestDTO{" +
                "'" + super.toString() + '\'' +
                ", recordId='" + recordId + '\'' +
