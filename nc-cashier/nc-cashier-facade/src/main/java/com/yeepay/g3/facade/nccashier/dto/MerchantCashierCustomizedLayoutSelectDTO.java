 ...
 */
public class MerchantCashierCustomizedLayoutSelectDTO extends BasicResponseDTO {
	 ...
	 * 商户收银台布局模板主键
	 */
	private String merchantLayoutId;
	...
	public String getMerchantLayoutId() {
		return merchantLayoutId;
	}

	public void setMerchantLayoutId(String merchantLayoutId) {
		this.merchantLayoutId = merchantLayoutId;
	}
	...
	public String toString() {
		...
		sb.append("merchantLayoutId='").append(merchantLayoutId).append('\'');
