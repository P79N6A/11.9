 ...
 * API收银台一键支付，请求发送验证码
 */
public class APIYJZFSendSmsRequestDTO extends APIBasicRequestDTO implements Serializable {
    private static final long serialVersionUID = 6550381427012767560L;
    /** 支付记录号 */
    ...
    public String toString() {
        return "APIYJZFSendSmsRequestDTO{" +
                "'" + super.toString() + '\'' +
                ", recordId='" + recordId + '\'' +
