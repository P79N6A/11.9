...
+function () {
     ...
     * description:命名空间，最顶层对象，To是唯一对外接口，继承exports
     */
    'use strict';
    ...
    window.To = Object.create(exports.prototype);
}();
/*========================================================================*/
+function (exports) {
    /**
...
+function (exports) {
    ...
    function loading(content, cls, boolTitle, boolClose, title, close) {
        ...
        To.Popup.base(content, cls, boolTitle, boolClose, title, close);
    }
...
+function (exports) {
    ...
    function _position() {//弹窗定位
        ...
        if (popupWindow < clientWindow) {
            popup.style.top = "50%";
            popup.style.marginTop = popupWindow / -2 + "px";
        } else {
    ...
    popup.prototype.base = function (content, cls, boolTitle, boolClose, title, close) {
        ...
        if (boolTitle || typeof boolTitle == "undefined") {
            if (boolClose || typeof boolClose == "undefined") {
                var closeBtn = '<span class="close" onclick="To.Popup.close()">' + close + '</span>';
            } else {
                var closeBtn = "";
            }
...
+function (exports) {
    ...
    To.ui.errorMsg = errorMsg;
    To.ui.errorMsg.hide = hide;
}(exports);